> **Note:** This repository is derived from the official MeanFlow implementation,
> [Gsunshine/meanflow](https://github.com/Gsunshine/meanflow), by Zhengyang Geng, Mingyang Deng,
> Xingjian Bai, J. Zico Kolter and Kaiming He. All credit for the method and the original code is
> theirs; it remains under the MIT license (see [LICENSE](./LICENSE)).
>
> This copy adds single-GPU support and a reproduction record — see [REPRODUCE.md](./REPRODUCE.md).
